...
export { default as LongList } from './components/LongList.vue'
export { default as ListPage } from './components/ListPage.vue'
export { default as DetailsPage } from './components/DetailsPage.vue'